          ...
          <div className="flex flex-wrap items-center gap-2">
            {isGoogleConnected ? (
              <>
                <Badge
                  variant="outline"
                  className="text-gray-600 dark:text-gray-300 border-gray-600 dark:border-gray-500 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800"
                ...
                {syncResult.syncResults?.errors &&
                  syncResult.syncResults.errors.length > 0 && (
                    <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 rounded-lg p-4">
                      ...
                      <div className="text-xs text-red-700 dark:text-red-200 space-y-1 max-h-32 overflow-y-auto">
            ...
            <CardContent className="py-4 sm:py-8">
              ...
              <div className="hidden sm:block overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
                  <tbody className="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-800">
                    <tr>
                      <td className="px-4 py-3 text-base font-medium text-gray-800 dark:text-gray-200">
                        Record Custom Payment
                      </td>
