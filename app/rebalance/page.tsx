        ...
        <div className="container mx-auto px-4 z-10 text-center">
          ...
          <AnimatedHero delay={0.4}>
            <p className="text-xl md:text-2xl text-white mb-8 max-w-4xl mx-auto">
              A hormone-free supplement system made of minty dissolvable
              lozenges designed to help balance your stress, energy, mood,
              sleep, and even weight loss resistance — all by supporting your
          ...
          <AnimatedHero delay={0.6}>
            <div className="mt-8">
              ...
              >
                <a
                  href="https://rebalancehealth.com"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Visit Rebalance Health{" "}
      ...
      <div className="container mx-auto px-4 py-12">
          ...
          <Card className="shadow-lg">
            ...
            <CardContent>
              <p className="text-gray-700 leading-relaxed">
                ...
                gives your body the tools to handle stress without needing
                hormone therapy or meds.
              </p>
            </CardContent>
          </Card>
        ...
        <div className="text-center bg-red-600 text-white p-12 rounded-lg">
          ...
          <p className="text-xl mb-8 opacity-90">
            Take the first step toward better stress management, improved sleep,
